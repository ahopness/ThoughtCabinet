package dev.lucasangelo.thoughtcabinet.components
...
fun BoxScope.FloatingNavigationBar(
    ...
    AnimatedContent(
        targetState = (currentDestination?.hasRoute<HomeScreen>() == true ||
                currentDestination?.hasRoute<CrowdScreen>() == true ||
                currentDestination?.hasRoute<SettingsScreen>() == true),
        transitionSpec = {
        ...
        Box() {
            ...
            val spacing = Arrangement.spacedBy(4.dp)
            ...
            Row(
                ...
                FloatingNavigationButton(
                    ...
                    title = "Home",
                    showTitle = currentDestination?.hasRoute<HomeScreen>() == true,
                    onClick = { onNavigate(HomeScreen, true) },
                )
                FloatingNavigationButton(
                    icon = R.drawable.icon_crowd,
                    title = "Crowd",
                    showTitle = currentDestination?.hasRoute<CrowdScreen>() == true,
                    onClick = { onNavigate(CrowdScreen, true) },
                )
                FloatingNavigationButton(
                    icon = R.drawable.icon_settings,
                    title = "Settings",
                    showTitle = currentDestination?.hasRoute<SettingsScreen>() == true,
                    onClick = { onNavigate(SettingsScreen, true) },
                )
            }

            AnimatedVisibility(
                currentDestination?.hasRoute<SettingsScreen>() == false,
                ...
                Column(
                    ...
                    AnimatedVisibility(newPostOptionsOpen) {
                        Column(
                            ...
                            if (currentDestination?.hasRoute<HomeScreen>() == true) {
                                FloatingNavigationButton(
                                ...
                                FloatingNavigationButton(
                                    icon = R.drawable.icon_media_post,
                                    title = "Media",
                                    showTitle = true,
                                    onClick = {},
                                )
                            ...
                            } else if (currentDestination?.hasRoute<CrowdScreen>() == true) {
                                FloatingNavigationButton(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .clickable(onClick = {
                                newPostOptionsOpen = !newPostOptionsOpen
                            })
                    )
                }
            }
